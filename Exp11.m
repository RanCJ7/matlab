...
hold on
for ac=1:AcN
    plot(Feature(2,(ac-1)*WNPA+1:ac*WNPA),...
        Feature(5,(ac-1)*WNPA+1:ac*WNPA),...
        '.','Color',[ac/5 (5-ac)/5 ac/5])
end
hold off
...
hold on
for ac=1:AcN
    plot(Feature(3,(ac-1)*WNPA+1:ac*WNPA),...
        Feature(6,(ac-1)*WNPA+1:ac*WNPA),...
        '.','Color',[ac/5 (5-ac)/5 ac/5])
end
hold off
...
for ac=1:AcN
    MeanX(ac) = mean(Feature(1,(ac-1)*WNPA+1:ac*WNPA));
    r(ac) = sqrt(sum((Feature(1,(ac-1)*WNPA+1:ac*WNPA)-MeanX(ac)).^2)/WNPA);
    for ac2=ac+1:AcN
        skewness(ac,ac2) = sum((Feature(1,(ac-1)*WNPA+1:ac*WNPA)-MeanX(ac)).^3) / (WNPA*r(ac)^3);
        skewness(ac2,ac) = skewness(ac,ac2);
    end
end
...
hold on
for ac=1:AcN
    % 通道1，特征1为X轴，通道1，特征2为Y轴，通道1，特征3为Z轴
    plot3(Feature(1,(ac-1)*WNPA+1:ac*WNPA),...
        Feature(2,(ac-1)*WNPA+1:ac*WNPA),...
        Feature(3,(ac-1)*WNPA+1:ac*WNPA),...
        '.','Color',[ac/5 (5-ac)/5 ac/5])
end
hold off
...
hold on
for ac=1:AcN
    % 通道2，特征1为X轴，通道2，特征2为Y轴，通道2，特征3为Z轴
    plot3(Feature(4,(ac-1)*WNPA+1:ac*WNPA),...
        Feature(5,(ac-1)*WNPA+1:ac*WNPA),...
        Feature(6,(ac-1)*WNPA+1:ac*WNPA),...
        '.','Color',[ac/5 (5-ac)/5 ac/5])
end
